            ...
            <tr class="diffusion-row" data-user-id="${u.id}" style="transition: background 0.15s;">
                ...
                <td style="text-align: center; padding: 10px 16px;">
                    <div style="display: flex; justify-content: center;">
                        <button class="btn btn-primary" onclick="sendPersonalPlanning('${u.id}', '${phone}')" style="padding: 6px 14px; font-size: 11px; background: var(--accent); display: inline-flex; align-items: center; gap: 6px; cursor: pointer; border-radius: 99px;">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-5 -10 110 135" width="12" height="12" fill="currentColor"><path d="m33.379 79.781c5.0781 2.8008 10.801 4.2695 16.621 4.2695 19.02 0 34.5-15.48 34.5-34.5s-15.48-34.5-34.5-34.5-34.5 15.48-34.5 34.5c0 6.1094 1.6094 12.09 4.6797 17.352l-4.3906 18.051zm1.832-46.352c0.73047-0.67188 1.6797-1.0312 2.6719-1.0312h1.0508c1.3906 0 2.6289 0.87109 3.1016 2.1719l2.1484 5.9219c0.19922 0.55859 0.10156 1.1797-0.26953 1.6484l-1.6992 2.1211c-0.67188 0.82812-0.85156 1.9609-0.46094 2.9492 2.0586 5.1797 8.1797 8.8203 11.379 10.422 1.1602 0.57813 2.5508 0.35938 3.4688-0.55078l1.8789-1.8789c0.44922-0.44922 1.1211-0.60938 1.7305-0.42188l5.6992 1.8203c1.3711 0.44141 2.3008 1.7109 2.3008 3.1484v1.4492c0 1.0586-0.42188 2.0781-1.1719 2.8281-5.5508 5.4805-14.762 1.4609-20.73-2.1992-4.3008-2.6406-8.0508-6.1094-10.84-10.32-6.75-10.188-2.6484-15.898-0.25781-18.078z"/></svg>
                            Envoyer
                        </button>
                    </div>
                </td>
